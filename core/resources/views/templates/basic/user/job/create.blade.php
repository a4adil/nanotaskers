...
<!--</div>-->
        ...
        <div class="wrapper mb-wrapper">
            <form class="create__campaigns__form" action="{{ route('user.job.store') }}" id="wizard" method="POST" enctype="multipart/form-data">
                @csrf
        		<!-- SECTION 1 -->
                <h4></h4>
                <section>
                	...
                	<div class="row">
                            ...
                            <div class="col-md-2">
                              <input type="radio" class="btn-check" name="continent" value="{{ $conti->code }}" id="{{ $conti->code }}" {{ $conti->code == "AS" ? "checked" : "" }} />
                    ...
                    <div class="row mb-countries">
                        <h3 class="mb-h3">Select ALL countries you want to INCLUDE from the selected zone (optional)</h3>
                            @foreach ($countries as $con)
                              <div class="col-md-2">
                                <input type="checkbox" class="btn-check" id="{{$con->country_id}}" value="{{$con->code}}" name="country[]" autocomplete="off" />
                ...
                <section>
                	...
                	<div class="row">
                            ...
                            @foreach ($categories as $category)
                            <div class="col-md-2">
                              <input type="radio" class="btn-check" name="category_id" value="{{ $category->id }}" id="c{{ $category->id }}" {{ $category->id == 17 ? "checked" : "" }} />
                	...
                	<div class="row mb-subcategories">
                        <h3 class="mb-cat-h3">Sub Category</h3>
                            @foreach ($subcategories as $subCat)
                              <div class="col-md-2">
                                <input type="radio" class="btn-check subcategory" id="sc{{$subCat->id}}" value="{{$subCat->id}}" name="subcategory" autocomplete="off" />
                ...
                <section>
                	...
                	<div class="row">
                	    <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input type="text" name="title" class="form-control form--control title" value="{{ old('title') }}">
                            </div>
                        </div>
                	</div>
                 ...
                 <!--       </div>-->
                	...
                	<div class="row">
                	    <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="step1_proof" class="form-control form--control" value="{{ old('step1_proof') }}">
                            </div>
                        </div>
                	...
                	<div class="row">
                	    <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="step2_proof" class="form-control form--control" value="{{ old('step2_proof') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control form--control h-50 w-100" name="job_proof2" id="fileOption">
                                <option value="" selected disabled>@lang('Select Type')</option>
                                <option value="1" @if (old('job_proof2') == 1) selected="selected" @endif>@lang("Optional")</option>
                                <option value="2" @if (old('job_proof2') == 2) selected="selected" @endif>@lang("Required")</option>
                            </select>
                        </div>
                	...
                	<div class="row">
                	    <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="step3_proof" class="form-control form--control" value="{{ old('step3_proof') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control form--control h-50 w-100" name="job_proof3" id="fileOption">
                                <option value="" selected disabled>@lang('Select Type')</option>
                                <option value="1" @if (old('job_proof3') == 1) selected="selected" @endif>@lang("Optional")</option>
                                <option value="2" @if (old('job_proof3') == 2) selected="selected" @endif>@lang("Required")</option>
                            </select>
                        </div>
                	...
                	<div class="row">
                	    <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="step4_proof" class="form-control form--control" value="{{ old('step4_proof') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control form--control h-50 w-100" name="job_proof4" id="fileOption">
                                <option value="" selected disabled>@lang('Select Type')</option>
                                <option value="1" @if (old('job_proof4') == 1) selected="selected" @endif>@lang("Optional")</option>
                                <option value="2" @if (old('job_proof4') == 2) selected="selected" @endif>@lang("Required")</option>
                            </select>
                        </div>
                 ...
                 <!--           </label><br>-->
                 <!--           <div class="input-group">-->
                 <!--               <input type="text" name="question1" class="form-control form--control" value="{{ old('question1') }}">-->
                 <!--           </div>-->
                 <!--       </div>-->
                 ...
                 <!--           </label><br>-->
                 <!--           <div class="input-group">-->
                 <!--               <input type="text" name="answer1" class="form-control form--control" value="{{ old('answer1') }}">-->
                 <!--           </div>-->
                 <!--       </div>-->
                	...
                	<div class="row">
                	    <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="question2" class="form-control form--control" value="{{ old('question2') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="answer2" class="form-control form--control" value="{{ old('answer2') }}">
                            </div>
                        </div>
                	...
                	<div class="row">
                	    <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="question3" class="form-control form--control" value="{{ old('question3') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="answer3" class="form-control form--control" value="{{ old('answer3') }}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control form--control h-50 w-100" name="level" id="fileOption">
                                ...
                                <option value="starter" @if (old('level') == 'starter') selected="selected" @endif>@lang("Starter")</option>
                                <option value="advanced" @if (old('level') == 'advanced') selected="selected" @endif>@lang("Advanced")</option>
                                <option value="expert" @if (old('level') == 'expert') selected="selected" @endif>@lang("Expert")</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" name="hold_job_time" min="3" max="60" class="form-control form--control" value="{{ old('hold_job_time') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control form--control h-50 w-100" name="promotion" id="promotion">
                                ...
                                <option value="no" @if (old('promotion') == 'no') selected="selected" @endif>@lang("No")</option>
                                <option value="yes" @if (old('promotion') == 'yes') selected="selected" @endif>@lang("Yes")</option>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="input-group">
                                    <input type="number" id="quantity" name="quantity" class="form-control form--control quantity" min="10" value="10">
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" id="workerwillearn" name="rate" class="form-control form--control rate" min="0" value="{{ old('rate') }}" readonly>
                            ...
                            <div class="col-xl-3">
                                <label for="country" class="form--label">@lang('Total Budget')</label>
                                <div class="input-group">
                                    <input type="text" id="total_budget" name="total_budget" class="form-control form--control total" value="{{ old('total_budget') }}" readonly>
...
@push('script')
    ...
    // $(window).click("div.actions ul li a", function(){
    //     setTimeout(() => {
    //         var a = "div.actions ul li a";
    //         // var f = $.each(a, function(i, item){
    //             //   var b = a[i].attr("href");
    ...
    $(document).ready(function(){
            ...
            $("#quantity, #promotion, .title, .nicEdit, #fileOption").change(function(){
