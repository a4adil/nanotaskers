...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::post('/job/getcountry', 'JobPostController@getcountry')->name('job.getcountry');
            Route::post('/job/getcategory', 'JobPostController@getcategory')->name('job.getcategory');
            Route::post('/job/getsubcategory', 'JobPostController@getsubcategory')->name('job.getsubcategory');
...
Route::get('blog/detail/{id}', 'SiteController@blogDetail')->name('blog.detail');
